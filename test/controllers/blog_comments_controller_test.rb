...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { author: @blog_comment.author, avatar: @blog_comment.avatar, blog_id: @blog_comment.blog_id, content: @blog_comment.content, rating: @blog_comment.rating }
    end
  ...
  test "should update blog_comment" do
    patch :update, id: @blog_comment, blog_comment: { author: @blog_comment.author, avatar: @blog_comment.avatar, blog_id: @blog_comment.blog_id, content: @blog_comment.content, rating: @blog_comment.rating }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
