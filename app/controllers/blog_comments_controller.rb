class BlogCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @blog_comment.save
        format.html { redirect_to blog_path(@blog), notice: 'Blog comment was successfully created.' }
        format.json { render action: 'show', status: :created, location: @blog_comment }
      else
        format.html { redirect_to blog_path(@blog), notice: 'Blog comment was not created.' }
  ...
  private
    ...
    def blog_comment_params
      params.require(:blog_comment).permit(:author, :content, :avatar, :rating, :blog_id)
    end
end
